...
export default function VacanceHalloween() {
  ...
  return (
       <Layout>
        <Head>
        <title>Vacances d'Halloween</title>
        <meta name="description" content="Le RUCB basket fete halloween"/>
